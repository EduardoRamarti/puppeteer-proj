...
describe('Emulando Dispositivos', () => {
  ...
  beforeAll(async () => {
    ...
    //Esta línea crea un nuevo contexto de navegador en modo incógnito utilizando el objeto browser.
    const context = await browser.createIncognitoBrowserContext()
    //Esta línea crea una nueva página dentro del contexto de navegador en modo incógnito que se creó anteriormente.
